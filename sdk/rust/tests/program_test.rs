...
use trezoa_system_interface::program::ID;
use tpl_associated_token_account_client::address::get_associated_token_address_with_program_id;
use tpl_associated_token_account_client::instruction::create_associated_token_account;
use tpl_token_2022::extension::default_account_state::instruction::initialize_default_account_state;
use tpl_token_2022::extension::ExtensionType;
use tpl_token_2022::instruction::initialize_mint2;
use tpl_token_2022::state::{AccountState, Mint};
...
impl TestContext {
    ...
    fn create_token(vm: &mut LiteSVM) -> TokenContext {
        ...
        let token_program_id = &tpl_token_2022::ID;
    ...
    pub fn setup_token_acl(&mut self) -> Pubkey {
        ...
        let ix = token_acl_client::instructions::CreateConfigBuilder::new()
            ...
            .system_program(ID)
            .token_program(tpl_token_2022::ID)
            .instruction();
