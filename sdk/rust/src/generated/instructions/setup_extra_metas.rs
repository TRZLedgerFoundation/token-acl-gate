...
pub const SETUP_EXTRA_METAS_DISCRIMINATOR: u8 = 4;
...
pub struct SetupExtraMetas {
    ...
    pub token_acl_mint_config: trezoa_pubkey::Pubkey,

    pub mint: trezoa_pubkey::Pubkey,

    pub extra_metas: trezoa_pubkey::Pubkey,
...
pub struct SetupExtraMetasBuilder {
    ...
    token_acl_mint_config: Option<trezoa_pubkey::Pubkey>,
    mint: Option<trezoa_pubkey::Pubkey>,
    extra_metas: Option<trezoa_pubkey::Pubkey>,
...
impl SetupExtraMetasBuilder {
    ...
    pub fn token_acl_mint_config(
        &mut self,
        token_acl_mint_config: trezoa_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn extra_metas(&mut self, extra_metas: trezoa_pubkey::Pubkey) -> &mut Self {
...
pub struct SetupExtraMetasCpiAccounts<'a, 'b> {
    ...
    pub token_acl_mint_config: &'b trezoa_account_info::AccountInfo<'a>,

    pub mint: &'b trezoa_account_info::AccountInfo<'a>,

    pub extra_metas: &'b trezoa_account_info::AccountInfo<'a>,
...
impl<'a, 'b> SetupExtraMetasCpiBuilder<'a, 'b> {
    ...
    pub fn token_acl_mint_config(
        &mut self,
        token_acl_mint_config: &'b trezoa_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn extra_metas(
        &mut self,
        extra_metas: &'b trezoa_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct SetupExtraMetasCpiBuilderInstruction<'a, 'b> {
    ...
    token_acl_mint_config: Option<&'b trezoa_account_info::AccountInfo<'a>>,
    mint: Option<&'b trezoa_account_info::AccountInfo<'a>>,
    extra_metas: Option<&'b trezoa_account_info::AccountInfo<'a>>,
