...
import { findWalletEntryPda, WalletEntrySeeds } from '../pdas';
...
export function getWalletEntryDecoder(): FixedSizeDecoder<WalletEntry> {
...
export function getWalletEntryCodec(): FixedSizeCodec<
  WalletEntryArgs,
  WalletEntry
> {
